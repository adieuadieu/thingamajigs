...
### NOTE: This experiment has graduated to it's own repository
Check out [serverless-chrome](https://github.com/adieuadieu/serverless-chrome) for a working version.
...
**Warning**: This is an experiment. This code is a mess and probably doesn't work.
